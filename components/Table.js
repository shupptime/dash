...
function EnhancedTableToolbar(props) {
    const { numSelected, catDelete } = props;
...
export default function EnhancedTable({ categorias }) {
    ...
    const [catDelete, setCatDelete] = React.useState({});
    console.log("selectedinit:", selected)
            ...
            <Paper sx={{ width: '100%', mb: 2 }}>
                ...
                <TableContainer>
                    ...
                    >
                        ...
                        <TableBody>
                            {
                                stableSort(categorias, getComparator(order, orderBy))
